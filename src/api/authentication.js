...
export const loginForMember = async params =>
    axios.post(MEMBER_LOGIN, params);
export const loginForAdmin = async params =>
    axios.post(ADMIN_LOGIN, params);

export const createMember = async params =>
    axios.post(MEMBER, params);

export const updateMember = async (memberId, params) =>
    axios.put(`${MEMBER}/${memberId}`, params);
