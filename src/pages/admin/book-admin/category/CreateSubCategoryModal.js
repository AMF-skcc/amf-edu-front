...
const CreateSubCategoryModal = ({ isCreateSubCategoryModalOpen = false, setIsCreateSubCategoryModalOpen }) => {
	...
	//Todo 수정필요....세부 카테고리와 카테고리가 어떻게 구성되는지에 따라..
	return (
		<Modal
		...
		>
			<Box sx={{ ...style, width: 400 }}>
				<h2 id="parent-modal-title">세부 카테고리 추가</h2>
				<Formik
					initialValues={{
						mainCategoryName: '',
						mainCategoryCode: '',
